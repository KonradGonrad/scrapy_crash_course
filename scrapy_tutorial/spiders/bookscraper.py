...
class BookscraperSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for book in books:
            ...
            yield response.follow(book_url, callback = self.parse_book_site, headers={"User-Agent": self.user_agent_list[random.randint(0, len(self.user_agent_list) - 1)]})
    ...
    def parse_book_site(self, response):
        ...
        book_item['price_ex_tax']  =   table_rows[2].css('td::text').get(),
        book_item['price_inc_tax'] =   table_rows[3].css('td::text').get(),
        book_item['tax']           =   table_rows[4].css('td::text').get(),
        book_item['avability']     =   table_rows[5].css('td::text').get(),
